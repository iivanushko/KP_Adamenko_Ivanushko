...
SELECT *
FROM (VALUES
    ('Брускетта с томатами', 95.00, 280.00, TRUE),
    ('Крем-суп грибной', 150.00, 360.00, TRUE),
    ('Лосось с рисом и зеленью', 390.00, 720.00, TRUE),
    ('Жульен с курицей', 185.00, 420.00, TRUE),
    ('Картофельный гратен', 120.00, 310.00, TRUE),
    ('Овощные канапе', 70.00, 190.00, TRUE),
    ('Мини-бургеры с говядиной', 240.00, 520.00, TRUE),
    ('Паста с креветками', 330.00, 680.00, TRUE),
    ('Медовик порционный', 105.00, 260.00, TRUE),
    ('Фруктовая тарелка', 170.00, 390.00, TRUE),
    ('Морс ягодный', 42.00, 120.00, TRUE),
    ('Свинина в сливочном соусе', 275.00, 610.00, FALSE)
) AS seed(dish_name, cost_price, sale_price, is_active)
WHERE NOT EXISTS (
