...
class OrderController extends AbstractController
{
    ...
    public function create(Request $request, OrderService $orders): RedirectResponse
    {
        try {
    ...
    public function edit(int $id, Request $request, OrderService $orders): RedirectResponse
    {
        try {
    ...
    public function inline(int $id, Request $request, OrderService $orders): RedirectResponse
    {
        try {
    ...
    public function cancel(int $id, Request $request, OrderService $orders): RedirectResponse
    {
        try {
